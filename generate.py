...
from modules import TREAT
from dataloader import LoadDataset
from Integerization import graph_collate_func
from configs import get_cfg_defaults
from RPAfusion import SYMBRIA_XFusion
...
# ===================== Global Settings =====================
BASE_OUT = "/home/fbm/TREAT/result/generate/"
os.makedirs(BASE_OUT, exist_ok=True)

CKPT_PATH = "/home/fbm/TREAT/result/KI-DTA.pth"
CFG_YAML  = "/home/fbm/TREAT/configs/TREAT.yaml"
BASE_CSV  = "/home/fbm/TREAT/datasets/Generate-sample.csv"
SAMPLE_IDX: int = 0
REGR_CKPT_PATH = "/home/fbm/TREAT/result/MIX-DTI.pth"
REGR_TH = 0.835
...
def export_Mod_d_from_csv(pth_path: str, cfg_yaml: str, one_row_csv: str, sample_idx: int = 1,
    ...
    model = TREAT(**cfg).to(device).eval()
